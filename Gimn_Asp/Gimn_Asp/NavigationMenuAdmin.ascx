...
<ul class="nav nav-pills flex-column mb-auto">
    <li class="nav-item">
        <asp:HyperLink ID="linkMetricasIngreso" runat="server" CssClass="nav-link" NavigateUrl="MetricasIngresos.aspx" Style="color: aliceblue;">
            <i class="bi bi-chart-line"></i> Métricas de Ingreso
        </asp:HyperLink>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <asp:HyperLink ID="linkListarEmpleados" runat="server" CssClass="nav-link" NavigateUrl="ListarEmpleados.aspx" Style="color: aliceblue;">
            <i class="bi bi-person-lines-fill"></i> Listar Empleados
        </asp:HyperLink>
    </li>
    <li class="nav-item">
        <asp:HyperLink ID="linkResumenCaja" runat="server" CssClass="nav-link" NavigateUrl="ResumenCaja.aspx" Style="color: aliceblue;">
            <i class="bi bi-cash-coin"></i> Resumen de Caja
        </asp:HyperLink>
    </li>
    <li>
